...
function TopScorers() {
  ...
  return (
    <div className="py-8">
      <SEO
        title="Top Scorers & Player Stats"
        description="Leading goal scorers and player statistics for Mora 9s Hockey Tournament 2026. Men's and women's tournament top scorers."
        path="/top-scorers"
      />
